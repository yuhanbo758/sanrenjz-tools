...
const services = {
  ...
  showSaveDialog: (defaultPath) => ipcRenderer.sendSync('show-save-dialog', {
    title: '保存 XML', defaultPath: defaultPath || 'output.xml',
    filters: [{ name: 'XML 文件', extensions: ['xml'] }, { name: '所有文件', extensions: ['*'] }]
  })
};
