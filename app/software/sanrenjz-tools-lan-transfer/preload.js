...
window.exports={'plugin-market-lan-transfer':{mode:'none',args:{enter:action=>dispatch('lan-transfer',action),search:(_a,_w,setList)=>setList([]),select:()=>{}}}};
