...
window.exports={'plugin-market-csv-table':{mode:'none',args:{enter:action=>dispatch('csv-table',action),search:(_a,_w,setList)=>setList([]),select:()=>{}}}};
